...
TOOL_DIR = ROOT / "tools" / "wikiwiki-crawler"
...
class WikiWikiCrawlerTest(unittest.TestCase):
    ...
    def test_playwright_config_does_not_require_copied_cookie(self):
        ...
        self.assertEqual(config["dailyLimit"], 30)
        self.assertEqual(config["maxAgeDays"], 20)
        self.assertEqual(config["catalogMaxAgeHours"], 22)
