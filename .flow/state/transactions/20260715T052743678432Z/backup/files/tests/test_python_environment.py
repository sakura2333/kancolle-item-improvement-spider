...
from script.project.environment import NEXT_ACTION, _parse_uv_version, inspect_project_environment
...
class PythonEnvironmentContractTest(unittest.TestCase):
    ...
    def test_mise_python_314_and_locked_uv_environment_is_ready(self):
        ...
        uv_version = type("Completed", (), {"returncode": 0, "stdout": "uv 0.11.28 (aarch64-apple-darwin)\n", "stderr": ""})()
    ...
    def test_uv_version_parser_accepts_platform_suffix(self):
        self.assertEqual(_parse_uv_version("uv 0.11.28 (aarch64-apple-darwin)\n"), "0.11.28")
        self.assertEqual(_parse_uv_version("uv 0.11.28\n"), "0.11.28")
