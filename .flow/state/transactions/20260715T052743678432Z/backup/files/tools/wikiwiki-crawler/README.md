...
The migration registers old `.spider/local/wikiwiki-crawler/raw/*.html` captures in `.spider/local/source-cache/**`. It never publishes credentials or browser state.
