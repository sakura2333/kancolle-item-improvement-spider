...
STABLE = {
    "include": [
        ".github/workflows/data-pipeline.yml", "LICENSE", "README.md", "RELEASE-NOTES.md",
        "VERSION", "mise.toml", "pyproject.toml", "uv.lock", "configs/**", "service/**", "util/**",
    ...
    "required": [
        "README.md", "VERSION", "docs/public/DATA-SCHEMA.md", "RELEASE-NOTES.md",
    ...
    "internalOnly": [
        ...
        "SPIDER-HARD-RULES.md", "SPIDER-AUTHORITY-MAP.md", ".flow/local/**",
    ],
