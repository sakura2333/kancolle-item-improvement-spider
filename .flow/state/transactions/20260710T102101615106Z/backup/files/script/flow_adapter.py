...
COMMANDS = {
    ...
    "run-wikiwiki-source": {"kind": "project", "handler": _PROJECT_HANDLER, "fixedArgs": ["wikiwiki", "--full"], "description": "兼容别名：执行完整 WikiWiki source acquisition"},
    ...
    "update-package": {"kind": "project", "handler": _PROJECT_HANDLER, "fixedArgs": ["update-package"], "description": "生成 Flow contentHash 业务更新包"},
}
...
PUBLIC_CAPABILITIES = {
    ...
    "run-wikiwiki-source": {"supported": True, "reason": None, "sideEffect": "L2", "profiles": [], "targets": []},
    ...
    "update-package": {"supported": True, "reason": None, "sideEffect": "L1", "profiles": [], "targets": []},
