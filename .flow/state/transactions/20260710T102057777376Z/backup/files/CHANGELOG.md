## [1.0.24] - 2026-07-06
- Flow 更新模型升级为 content baseline：新增 `.flow/baseline.json`、`flow-content-sha256`、dependency `lockHash`、Quick Receipt 绑定与 `update-package` 业务包生成入口；Git commit 只作为更新闭环后的落地/审计结果。
