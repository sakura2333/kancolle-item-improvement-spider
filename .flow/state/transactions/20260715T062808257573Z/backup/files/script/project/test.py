...
BEFORE_TEST_MODULES = (
    ...
    "tests.test_npm_beta",
    "tests.test_path_contract_governance",
    "tests.test_public_data_package_docs",
    "tests.test_public_candidate_check",
    "tests.test_public_content_audit",
    "tests.test_release_transaction",
    "tests.test_public_automation_bundle",
    "tests.test_github_action_pipeline",
    "tests.test_consumer_identity",
    "tests.test_npm_business_identity",
    "tests.test_npm_release_set",
    "tests.test_official_assets",
    "tests.test_asset_projection",
    "tests.test_akashi_image_downloads",
    "tests.test_cache",
...
AFTER_TEST_MODULES = (
    ...
    "tests.test_equipment_acquisition_snapshot",
    "tests.test_equipment_sources",
