...
def build_release_set(
    ...
    *,
    ...
    _verify_tarball(current_verify, schema_version=4, compatibility=False)
    _verify_tarball(compatibility_verify, schema_version=3, compatibility=True)
...
def verify_release_set(path: Path) -> dict[str, Any]:
    ...
    for artifact in artifacts:
        ...
        _verify_tarball(verification_artifact, schema_version=schema, compatibility=variant == "improvement2")
    return payload
