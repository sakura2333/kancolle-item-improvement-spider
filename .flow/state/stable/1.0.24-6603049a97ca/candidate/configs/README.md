...
- Generated data, source caches, reports, and package staging outputs are runtime artifacts. They should be ignored or exported through Flow, not mixed into code commits.
