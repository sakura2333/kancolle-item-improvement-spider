...
`dist/packages/kancolle-data/equipment/sources.nedb` contains one record for every player equipment in Start2. All three arrays are required even when empty:
